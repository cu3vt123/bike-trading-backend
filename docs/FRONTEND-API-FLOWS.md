...
Luồng nghiệp vụ đầy đủ (kho vs direct): [business-rules/BUSINESS-RULES.md](business-rules/BUSINESS-RULES.md), [STATE_TRANSITION_DIAGRAM_GUIDE.md](STATE_TRANSITION_DIAGRAM_GUIDE.md).
